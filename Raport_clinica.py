...
"""insert_data("C:\\Temp\\Python\\FacultateApp\\static\\files\\materii.txt","Materii")
insert_data("C:\\Temp\\Python\\FacultateApp\\static\\files\\profesori.txt","Profesori")
process_data("yyy.txt")  """  