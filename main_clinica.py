...
def DisplayReport_Specializare_Calificare(filename):
    return redirect(url_for('static',filename= "/files/Raport_Specializari_Calificare.txt",code=301))
...
def DisplayReport_Total_Incasari(filename):
    return redirect(url_for('static',filename= "/files/Raport_Total_Incasari.txt",code=301))
